...
# --- 3. CSS TỔNG LỰC: ÉP FONT, SIZE VÀ HIỆU ỨNG HOA RƠI ---
...
st.markdown(f"""
    ...
    .title-dragon {{ font-family: 'Great Vibes', cursive !important; color: #FFD700 !important; font-size: 80px !important; text-shadow: 4px 4px 10px #000; }}
    .text-phoenix {{ font-family: 'Dancing Script', cursive !important; color: #F8F9FA !important; font-size: 40px !important; }}

    .interaction-area {{ margin-top: 420px; text-align: center; width: 100%; }}

    /* INPUT TÊN */
    div.stTextInput input {{
        font-family: 'Dancing Script', cursive !important; font-size: 16px !important; 
        text-align: center; height: 45px !important; border: 2px solid #FFD700 !important;
        border-radius: 15px !important;
    }}

    /* --- ÉP PHÊ CHO OPTION (Túi lộc) --- */
    ...
    .option-container div.stButton > button p {{
        ...
        font-size: 50px !important; /* ĐÚNG 50PX */
        font-weight: 900 !important;
        color: #800000 !important;
        text-shadow: none !important;
    }}

    /* --- ÉP PHÊ CHO NÚT CHUYỂN TIẾP --- */
    .nav-container div.stButton > button {{
        height: 80px !important; max-width: 400px !important; margin: 0 auto !important;
